...
public class SCXML2VoiceXMLJ {
    ...
    public static void main(String[] args) {
        ...
        try {
            //args = new String[]{"-i", "src/main/resources/run-data/registration.scxml", "-s", "src/main/resources/run-data/registration.grxml", "-v", "src/main/resources/run-data/voicexml.vxml"};
